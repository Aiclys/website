+++
title = 'Resources'
date = 2024-01-12T19:42:33+01:00
+++

# DISCLAIMER:
### Just because I list them here it doesn't mean that I endorse everything that is listed in these resources. Always think about the things you read online and proceed with common sense.
&nbsp;
&nbsp;
### This is a place where I share very helpful resources about online privacy, Linux, BSD and FLOSS in general. I will also link to other websites I found on the world wide web that I liked or found interesting in some way. Oh and you will also find a list of software I use on a daily basis. I'd be very happy if you added me to your website. Here's my site button (If you want to be added to my site, send me an email and I'll add your button/link):
![site button](/mybutton.png)
...
- ### [Linux and BSD resources](#linux-and-bsd-resources)
  - #### [Linux Youtubers](#linux-youtubers)
  - #### [BSD Youtubers](#bsd-youtubers)
- ### [Online privacy resources](#online-privacy-resources)
...
&nbsp;
# Links:
#### These are cool websites I found on webrings or that have interesting blogs/articles:
- ### [DigDeeper](https://digdeeper.club/)
- ### [Eric Murphy](https://ericmurphy.xyz/)
- ### [Rys](https://rys.io/)
- ### [WhiteVhs](http://whitevhs.xyz)
- ### [Sadness](https://sadgrl.online/)
- ### [CiphersByRitter](http://ciphersbyritter.com/)
- ### [Luke Smith](https://lukesmith.xyz)
- ### [Landchad](https://landchad.net/)
- ### [Tilde](https://tilde.club/)
- ### [Chadnet](https://chadnet.org)
- ### [Godcock](https://godcock.neocities.org/)
...
- ####  The [BSD for Linux users blog](https://www.over-yonder.net/~fullermd/rants/bsd4linux/01/) is a really great blog I found online that talks about the main differences between Linux and BSD and the personal experience of a FreeBSD user. Although it is a subjective blog, it is really informative and does a great job at explaining BSD concepts. Keep in mind that the target audience are Linux users who already hove a bit of knowledge about Linux.
    ...
    - #### [The Linux Experiment(youtube)](https://www.youtube.com/@TheLinuxEXP) / [The Linux Experiment(website)](https://thelinuxexp.com/)
